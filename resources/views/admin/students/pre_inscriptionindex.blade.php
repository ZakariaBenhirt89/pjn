                                ...
                                <div class="nk-block-between position-relative">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            <h2 class="nk-block-title fw-normal"><img style="width: 9%;" src="{{ asset('images/pre_registration.svg') }}"> Tous Les Pre-Registration</h2>
                                ...
                                <div class="card-inner">
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                        ...
                                        <tr class="nk-tb-item nk-tb-head">
                                            ...
                                            <th class="nk-tb-col tb-col-md"><span class="sub-text">Date de naissance</span></th>
                                            <th class="nk-tb-col tb-col-lg"><span class="sub-text">N° cin </span></th>
                                            <th class="nk-tb-col tb-col-lg"><span class="sub-text">Téléphone 1</span></th>
                                        ...
                                        @isset($acceuils)
                                            ...
                                            <td class="nk-tb-col">
                                                <div class="user-card">
                                                    @if($acceuil->image_profile)
                                                        <img style="width: 23%;margin-right: 6px;" src="{{ asset('images/acceuil/'.$acceuil->image_profile) }}" />
                                                    @else
                                            ...
                                            </td> <td class="nk-tb-col tb-col-md">
                                                <span class="tb-status text-warning">
                                                    @if($acceuil->status == 'in_active')
                                                        En Attendant
                                                    @else
                                                        {{$acceuil->status}}
                                                    @endif
                                                ...
                                                <ul class="nk-tb-actions gx-1">
                                                    ...
                                                    <li>
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a href="{{ route('pre-inscription.details',$acceuil->id) }}"><em class="icon ni ni-eye"></em><span>Afficher les détails</span></a></li>
                                                                    <li><a href="{{ route('pre-inscription.complete',$acceuil->id) }}"><em class="icon ni ni-eye"></em><span>Completer Inscription</span></a></li>

                                                                    <li class="divider"></li>

                                                                    <li><a href="#"><em class="icon ni ni-na"></em><span>Suspendre Inscription</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </li>
