                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 pb-30">
                        <div style="height: 100%;" class="about-item-card about-item-card-thirdcolor">
                            ...
                            <div class="about-card-text">
                                <h6><span style="color: #06933e;" class="">1  </span></h6>
                                <p>Réduction des déficits n infrastructures et services sociaux de base</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-lg-3 pb-30">
                        <div style="height: 100%;" class="about-item-card about-item-card-thirdcolor">
                            ...
                            <div class="about-card-text">
                                <h6><span style="color: #06933e;" class="">2   </span></h6>
                                <p>Accompagnement des personnes en situation de précarité</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-lg-3 pb-30">
                        <div style="height: 100%;" class="about-item-card about-item-card-thirdcolor">
                            ...
                            <div class="about-card-text">
                                <h6><span style="color: #06933e;" class="">3   </span></h6>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 pb-30">
                        <div style="height: 100%;" class="about-item-card about-item-card-thirdcolor">
                            ...
                            <div class="about-card-text">
                                <h6><span style="color: #06933e;" class="">4 </span></h6>
                                <p>Impulsion du capital humain des générations montantes</p>
                            </div>
                        </div>
                    </div>
