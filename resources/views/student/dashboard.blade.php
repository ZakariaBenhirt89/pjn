                    ...
                    <div class="nk-header-menu" data-content="headerNav">
                        ...
                        <ul class="nk-menu nk-menu-main ui-s2">
                            <li class="nk-menu-item active current-page">
                                <a href="html/invest/index.html" class="nk-menu-link" data-original-title="" title="">
...
<!-- app-root @e -->
<!-- JavaScript -->
<script src="{{ asset('student_assets/js/bundle.js?ver=2.8.0') }}"></script>
<script src="{{ asset('student_assets/js/scripts.js?ver=2.8.0') }}"></script>
<script src="{{ asset('student_assets/js/charts/gd-invest.js?ver=2.8.0') }}"></script>
</body>
